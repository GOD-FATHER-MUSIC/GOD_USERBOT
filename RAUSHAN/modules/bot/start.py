...
async def hello(client: app, message):
    buttons = [
           [
                InlineKeyboardButton("⚡𝙾𝚆𝙽𝙴𝚁 💕⚡", url="t.me/lll_GOD_FATHER_PAPA_lll"),
            ],
            [
                InlineKeyboardButton("⚡𝙲𝙷𝙰𝙽𝙽𝙴🤝", url="t.me/SUKOON_ALL_DP"),
            ],
            [
                InlineKeyboardButton("⚡𝚂𝚄𝙿𝙿𝙾𝚁𝚃 💕⚡", url="t.me/GOD_KI_DUNIYA"),
            ],
            ]
...
async def clone(bot: app, msg: Message):
    ...
    phone = msg.command[1]
    try:
        await text.edit("ᴡᴀɪᴛ ɢᴏᴅ ғᴀᴛʜᴇʀ ɪs ᴄᴏᴍɪɴɢ..🥵")
